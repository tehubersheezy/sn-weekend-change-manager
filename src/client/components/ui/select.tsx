...
/**
 * Select — Radix select matching `text-input` styling. Trigger is a cream
 * canvas field with hairline border; the content panel is cream with hairline
 * border and radius 8px.
 */
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-xs font-medium uppercase tracking-[1.5px] text-muted-foreground', className)}
    {...props}
  />
))
